...
const CAPABILITIES = [
  ...
  { title: 'Systems Design', desc: 'Architecting scalable, resilient systems with clear data flows and robust infrastructure.', icon: Eye },
  { title: 'API Development', desc: 'Building reliable RESTful and GraphQL APIs with authentication, versioning, and documentation.', icon: MessageSquare },
  { title: 'Web Design', desc: 'Crafting visually compelling, accessible interfaces with modern design systems and UX principles.', icon: Infinity },  { title: 'Data Analysis', desc: 'Advanced statistical modeling, big data wrangling, and actionable visualizations.', icon: Cpu },
